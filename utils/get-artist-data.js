...
async function lookupArtist({ artistId, spotifyAccessToken }) {
...
async function lookupRelatedArtists({ artistId, spotifyAccessToken }) {
  const artistResponse = await fetch(
...
async function lookupArtistTracks({ artistId, spotifyAccessToken }) {
...
async function getArtistData({ pathParam, spotifyAccessToken }) {
  // read the name and the playlist IDs from the posted data

  const artistId = pathParam;
